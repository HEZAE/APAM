...
val TwilightDarkColorScheme = darkColorScheme(
    ...
    background = Color(0xFF9D9393),           // 应用程序背景颜色，深色
    onBackground = Color.White,                // 在背景上的白色文本
    surface = Color(0xFF837979),               // 表面颜色，暗调
    ...
    scrim = Color(0xFF545050).copy(alpha = 0.32f), // 模糊背景颜色
    surfaceBright = Color(0xFF5D5757),         // 明亮的表面颜色
    surfaceContainer = Color(0xFF303030),      // 表面容器颜色
    surfaceContainerHigh = Color(0xFF4D4949),  // 较高的表面容器颜色
...
val TwilightLightColorScheme = lightColorScheme(
    ...
    onPrimary = Color(0xFFF3DCCC),                  // 在主要颜色上的黑色文本
    primaryContainer = Color(0xFFFFD700),    // 主要容器的金色
    onPrimaryContainer = Color(0xFFF3DCCC),         // 在主要容器上的黑色文本
    inversePrimary = Color(0xFF5B5454),      // 反向主要颜色
    secondary = Color(0xFFFFC107),           // 明亮的琥珀色
    onSecondary =Color(0xFFD3C9BD),                // 在次要颜色上的黑色文本
    secondaryContainer = Color(0xFFFFD54F),   // 次要容器的浅琥珀色
    onSecondaryContainer = Color(0xFFD3C9BD),       // 在次要容器上的黑色文本
    tertiary = Color(0xFFFFEB3B),            // 明亮的浅黄色
    onTertiary = Color(0xFFF3DCCC),                 // 在三次颜色上的黑色文本
    tertiaryContainer = Color(0xFFFFF9C4),    // 三次容器的极浅黄色
    onTertiaryContainer = Color(0xFFF3DCCC),        // 在三次容器上的黑色文本
    background = Color(0xFFFFF3E0),          // 应用程序背景颜色
    onBackground = Color(0xFFD3C9BD),                // 在背景上的黑色文本
    surface = Color(0xFFFFE0B2),              // 表面颜色
    onSurface = Color(0xFFD3C9BD),                   // 在表面上的黑色文本
    surfaceVariant = Color(0xFFFFCC80),       // 表面变体颜色
    onSurfaceVariant = Color(0xFFD3C9BD),            // 在表面变体上的黑色文本
    surfaceTint = Color(0xFFFFB74D),          // 表面颜色的 tint
    inverseSurface = Color(0xFF797474),       // 反向表面颜色
    inverseOnSurface = Color.White,            // 在反向表面上的白色文本
    error = Color(0xFFD32F2F),                // 错误颜色
    onError = Color.White,                     // 在错误颜色上的白色文本
    errorContainer = Color(0xFFF9BBAE),       // 错误容器颜色
    ...
    outline = Color(0xFFB0B0B0),               // 边框颜色
    outlineVariant = Color(0xFFD0D0D0),        // 边框变体颜色
    scrim = Color(0xFF796969).copy(alpha = 0.32f), // 模糊背景颜色
